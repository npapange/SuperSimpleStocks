    ...
    try:
        if len(user_provided_args) < 5:
            Stock(user_provided_args[0], user_provided_args[1], user_provided_args[2], user_provided_args[3],
                  current_stock_exchange=market_exchange)
        elif len(user_provided_args) == 5:
            Stock(user_provided_args[0], user_provided_args[1], user_provided_args[2], user_provided_args[3],
                  user_provided_args[4], market_exchange)
...
def remove_stock():
    """
    A console wrapper for StockExchange.remove_existing_stock
    :return: Recursion
    """
    global market_exchange
...
def add_trade(from_='add_trade'):
    ...
    if market_exchange.registered_stocks:
        ...
        if market_exchange.is_stock_registered(user_provided_args[0]):
            ...
            try:
                if len(user_provided_args) < 5:
                    TradeRecord(market_exchange, user_provided_args[0], user_provided_args[1], user_provided_args[2],
                                user_provided_args[3])
                elif len(user_provided_args) == 5:
                    TradeRecord(market_exchange, user_provided_args[0], user_provided_args[1], user_provided_args[2],
                                user_provided_args[3], user_provided_args[4])
